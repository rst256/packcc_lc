...
#define _1e __pcc_in->data.leaf.capts.buf[0]->range.end
    if(is_error) printf("error\n"); else printf("`%s`=%f\n", _1, e); is_error = 0;
    int i=0;for (; vars[i].name; i++); vars[i].name = strdup(_1); vars[i].value = e;
#undef _1e
#undef _1s
#undef _1
#undef _0e
...
static void pcc_action_statement_2(calc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
#define _0s ((const)__pcc_in->data.leaf.capt0.range.start)
...
static void pcc_action_primary_2(calc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define e (*__pcc_in->data.leaf.values.buf[0])
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
...
static void pcc_action_var_0(calc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
#define _0s ((const)__pcc_in->data.leaf.capt0.range.start)
...
#define _1s __pcc_in->data.leaf.capts.buf[0]->range.start
#define _1e __pcc_in->data.leaf.capts.buf[0]->range.end
    for (int i=0; vars[i].name; i++){		if(!strcmp(vars[i].name, _1)){ __ = vars[i].value; return; };	} printf("error var `%s` not defined\n", _1); is_error = 1; 
#undef _1e
#undef _1s
#undef _1
#undef _0e
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_var(calc_context_t *ctx);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_statement(calc_context_t *ctx) {
    ...
    pcc_capture_table__resize(ctx->auxil, &chunk->capts, 1);
    {
        ...
        {
            pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_statement_0, 1, 1);
    ...
    L0002:;
        ...
        {
            pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_statement_1, 1, 1);
            thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
    ...
    L0003:;
        ...
        {
            pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_statement_2, 1, 1);
            thunk->data.leaf.capt0.range.start = chunk->pos;
            thunk->data.leaf.capt0.range.end = ctx->pos;
            pcc_thunk_array__add(ctx->auxil, &chunk->thunks, thunk);
        }
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_primary(calc_context_t *ctx) {
    ...
    L0004:;
        ...
        ctx->pos++;
        {
            pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_primary_2, 1, 1);
            thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
            thunk->data.leaf.capt0.range.start = chunk->pos;
            thunk->data.leaf.capt0.range.end = ctx->pos;
            pcc_thunk_array__add(ctx->auxil, &chunk->thunks, thunk);
...
int calc_parse(calc_context_t *ctx, double *ret) {
    pcc_thunk_array_t thunks;
