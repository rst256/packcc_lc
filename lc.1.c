...
#include "lc.h"
    ...
    int col = 1, line = 1, line_begin_pos=0;
    int col_start = 1, line_start = 1;
...
#define PCC_BUFFERSIZE 1024
    ...
    #define  ERROR(...) _ERROR(auxil->file_name, line, _0e-line_begin_pos, __VA_ARGS__)

    #define  _WARN(F, L, C, ...) { printf("%s:%d:%d: %d:%d:", F, L, C, line_start, col_start); printf(__VA_ARGS__); }
    #define  WARN(...) _WARN(auxil->file_name, line, col, __VA_ARGS__)
...
#line 36 "C:\\lib\\packcc\\lc.cc"
    col_start = col, line_start = line;
#
#undef _0e
#undef _0s
#undef _0
...
#define _0s ((const)__pcc_in->data.leaf.capt0.range.start)
#define _0e ((const)__pcc_in->data.leaf.capt0.range.end)
#line 41 "C:\\lib\\packcc\\lc.cc"
    __ = e; if(__.species=='+' || __.species=='-' || __.species=='*' || __.species=='/') 
    printf("binop: %f %c %f = %f\n", __.larg->number, __.species, __.rarg->number, __.number); 
#
#undef _0e
#undef _0s
#undef _0
...
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
__.larg = (__pcc_in->data.leaf.values.buf[0]);
#define larg (*__pcc_in->data.leaf.values.buf[0])
__.rarg = (__pcc_in->data.leaf.values.buf[1]);
#define rarg (*__pcc_in->data.leaf.values.buf[1])
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
#define _0s ((const)__pcc_in->data.leaf.capt0.range.start)
#define _0e ((const)__pcc_in->data.leaf.capt0.range.end)
#define _1_ (__pcc_in->data.leaf.capts.buf[0]->alt_index)
#define _1 pcc_get_capture_string(__pcc_ctx, __pcc_in->data.leaf.capts.buf[0])
#define _1s __pcc_in->data.leaf.capts.buf[0]->range.start
#define _1e __pcc_in->data.leaf.capts.buf[0]->range.end
#line 45 "C:\\lib\\packcc\\lc.cc"
    __.species = *_1; 
    __.number = larg.number + (__.species=='-' ? -1 : 1) * rarg.number; 
#
#undef _1e
#undef _1s
#undef _1
...
#define _1s __pcc_in->data.leaf.capts.buf[0]->range.start
#define _1e __pcc_in->data.leaf.capts.buf[0]->range.end
#line 51 "C:\\lib\\packcc\\lc.cc"
    __.species = *_1; 
    __.number = FACTOR(__.species,	larg ,rarg)  ; 
#
#undef _1e
#undef _1s
#undef _1
...
static void pcc_action_unary_1(lc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define e (*__pcc_in->data.leaf.values.buf[0])
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
...
static void pcc_action_unary_2(lc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define tt (*__pcc_in->data.leaf.values.buf[1])
#define e (*__pcc_in->data.leaf.values.buf[0])
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
#define _0s ((const)__pcc_in->data.leaf.capt0.range.start)
#define _0e ((const)__pcc_in->data.leaf.capt0.range.end)
...
static void pcc_action_unary_3(lc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define e (*__pcc_in->data.leaf.values.buf[0])
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
...
static void pcc_action_unary_4(lc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define e (*__pcc_in->data.leaf.values.buf[0])
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
...
#define _0s ((const)__pcc_in->data.leaf.capt0.range.start)
#define _0e ((const)__pcc_in->data.leaf.capt0.range.end)
    { fprintf(stderr, "expected `]`"); exit(1); }
#undef _0e
#undef _0s
#undef _0
#undef d
...
static void pcc_action_var_0(lc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
#define _0s ((const)__pcc_in->data.leaf.capt0.range.start)
...
#define _1s __pcc_in->data.leaf.capts.buf[0]->range.start
#define _1e __pcc_in->data.leaf.capts.buf[0]->range.end
#line 80 "C:\\lib\\packcc\\lc.cc"
    for (int i=0; vars[i].name; i++){		
            if(!strcmp(vars[i].name, _1)){ 
                    __.number = vars[i].value; return; 
            }
    } 
...
static void pcc_action_IDENT_0(lc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
#define _0s ((const)__pcc_in->data.leaf.capt0.range.start)
...
static void pcc_action_define_assign_var_stat_0(lc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define def (*__pcc_in->data.leaf.values.buf[0])
...
#define _2s __pcc_in->data.leaf.capts.buf[1]->range.start
#define _2e __pcc_in->data.leaf.capts.buf[1]->range.end
#line 93 "C:\\lib\\packcc\\lc.cc"
    printf("defassign_var_stat: %s = %s\n", _1, _2); 
#
#undef _2e
#undef _2s
#undef _2
...
static void pcc_action_define_var_stat_0(lc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
...
static void pcc_action_define_var_stat_1(lc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define te (*__pcc_in->data.leaf.values.buf[0])
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
...
static void pcc_action_define_var_0(lc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define te (*__pcc_in->data.leaf.values.buf[0])
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
...
static void pcc_action_define_var_1(lc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define te (*__pcc_in->data.leaf.values.buf[0])
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
...
#define __ (*__pcc_out)
#define e (*__pcc_in->data.leaf.values.buf[0])
#define fields (*__pcc_in->data.leaf.values.buf[3])
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
#define _0s ((const)__pcc_in->data.leaf.capt0.range.start)
#define _0e ((const)__pcc_in->data.leaf.capt0.range.end)
#line 103 "C:\\lib\\packcc\\lc.cc"
    printf("fields: %p\n", &fields);
#
#undef _0e
#undef _0s
...
static void pcc_action_type_expr_4(lc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
#define _0s ((const)__pcc_in->data.leaf.capt0.range.start)
...
static void pcc_action_type_expr_5(lc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
#define _0s ((const)__pcc_in->data.leaf.capt0.range.start)
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_var(lc_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_ident(lc_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_IDENT(lc_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_define_assign_var_stat(lc_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_define_var_stat(lc_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_define_var(lc_context_t *ctx);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_statement(lc_context_t *ctx) {
    ...
    pcc_capture_table__resize(ctx->auxil, &chunk->capts, 0);
    {
        ...
        int n = chunk->thunks.len;
            ...
            int p = ctx->pos;
            int n = chunk->thunks.len;
                        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_assign, &chunk->thunks, NULL)) goto L0004;
            goto L0003;
        L0004:;
            ctx->pos = p;
            pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
                                    if (!pcc_apply_rule(ctx, pcc_evaluate_rule_define_assign_var_stat, &chunk->thunks, NULL)) goto L0005;
            goto L0003;
        L0005:;
            ctx->pos = p;
            pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
                                    if (!pcc_apply_rule(ctx, pcc_evaluate_rule_define_var_stat, &chunk->thunks, NULL)) goto L0006;
            goto L0003;
        L0006:;
            ctx->pos = p;
            pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_factor(lc_context_t *ctx) {
    ...
    L0002:;
        ctx->pos = p;
        pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
                        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_unary, &chunk->thunks, &(chunk->values.buf[2]))) goto L0006;
        {
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_unary(lc_context_t *ctx) {
    ...
    L0002:;
        ...
        {
            pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_unary_1, 2, 1);
            thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
            thunk->data.leaf.capt0.range.start = chunk->pos;
            thunk->data.leaf.capt0.range.end = ctx->pos;
            pcc_thunk_array__add(ctx->auxil, &chunk->thunks, thunk);
    ...
    L0003:;
        ...
        {
            int p = ctx->pos, q;
            if (!pcc_apply_rule(ctx, pcc_evaluate_rule_type_expr, &chunk->thunks, &(chunk->values.buf[1]))) goto L0004;
            q = ctx->pos;
            chunk->capts.buf[0].range.start = p;
            chunk->capts.buf[0].range.end = q;
                    }
        ...
        {
            pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_unary_2, 2, 1);
            thunk->data.leaf.values.buf[1] = &(chunk->values.buf[1]);
            thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
            thunk->data.leaf.capts.buf[0] = &(chunk->capts.buf[0]);
            thunk->data.leaf.capt0.range.start = chunk->pos;
    ...
    L0004:;
        ctx->pos = p;
        pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
                        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_primary, &chunk->thunks, &(chunk->values.buf[0]))) goto L0005;
    ...
    L0006:;
        ...
        ctx->pos++;
        {
            pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_unary_3, 2, 1);
            thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
            thunk->data.leaf.capt0.range.start = chunk->pos;
            thunk->data.leaf.capt0.range.end = ctx->pos;
            pcc_thunk_array__add(ctx->auxil, &chunk->thunks, thunk);
    ...
    L0005:;
        ...
        {
            pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_unary_4, 2, 1);
            thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
            thunk->data.leaf.capt0.range.start = chunk->pos;
            thunk->data.leaf.capt0.range.end = ctx->pos;
            pcc_thunk_array__add(ctx->auxil, &chunk->thunks, thunk);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_primary(lc_context_t *ctx) {
    ...
    pcc_capture_table__resize(ctx->auxil, &chunk->capts, 2);
    {
        ...
        {
            pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_primary_0, 2, 2);
            thunk->data.leaf.capts.buf[0] = &(chunk->capts.buf[0]);
            thunk->data.leaf.capt0.range.start = chunk->pos;
            thunk->data.leaf.capt0.range.end = ctx->pos;
            pcc_thunk_array__add(ctx->auxil, &chunk->thunks, thunk);
    ...
    L0002:;
        ...
        L0005:;
            ...
            L0006:;
                {
                    pcc_value_t null;
                    pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_primary_1, 2, 2);
                    thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
                    thunk->data.leaf.values.buf[1] = &(chunk->values.buf[1]);
                    thunk->data.leaf.capt0.range.start = chunk->pos;
                    thunk->data.leaf.capt0.range.end = ctx->pos;
        ...
        {
            pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_primary_2, 2, 2);
            thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
            thunk->data.leaf.values.buf[1] = &(chunk->values.buf[1]);
            thunk->data.leaf.capts.buf[1] = &(chunk->capts.buf[1]);
            thunk->data.leaf.capt0.range.start = chunk->pos;
    ...
    L0004:;
        ctx->pos = p;
        pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
                        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_var, &chunk->thunks, &(chunk->values.buf[0]))) goto L0008;
        {
            pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_primary_3, 2, 2);
            thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
            thunk->data.leaf.capt0.range.start = chunk->pos;
            thunk->data.leaf.capt0.range.end = ctx->pos;
            pcc_thunk_array__add(ctx->auxil, &chunk->thunks, thunk);
    ...
    L0008:;
        ...
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_expression, &chunk->thunks, &(chunk->values.buf[0]))) goto L0009;
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule__, &chunk->thunks, NULL)) goto L0009;
        if (
            pcc_refill_buffer(ctx, 1) < 1 ||
            ctx->buffer.buf[ctx->pos] != ')'
        ...
        ctx->pos++;
        {
            pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_primary_4, 2, 2);
            thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
            thunk->data.leaf.capt0.range.start = chunk->pos;
            thunk->data.leaf.capt0.range.end = ctx->pos;
            pcc_thunk_array__add(ctx->auxil, &chunk->thunks, thunk);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_var(lc_context_t *ctx) {
    ...
    {
        pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_var_0, 0, 1);
        thunk->data.leaf.capts.buf[0] = &(chunk->capts.buf[0]);
        thunk->data.leaf.capt0.range.start = chunk->pos;
        thunk->data.leaf.capt0.range.end = ctx->pos;
        pcc_thunk_array__add(ctx->auxil, &chunk->thunks, thunk);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_IDENT(lc_context_t *ctx) {
    ...
    L0001:;
        {
            pcc_value_t null;
            pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_IDENT_0, 0, 0);
            thunk->data.leaf.capt0.range.start = chunk->pos;
            thunk->data.leaf.capt0.range.end = ctx->pos;
            memset(&null, 0, sizeof(pcc_value_t)); /* in case */
            thunk->data.leaf.action(ctx, thunk, &null);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_define_assign_var_stat(lc_context_t *ctx) {
    ...
    pcc_capture_table__resize(ctx->auxil, &chunk->capts, 2);
    {
        ...
        {
            int p = ctx->pos, q;
            if (!pcc_apply_rule(ctx, pcc_evaluate_rule_define_var, &chunk->thunks, &(chunk->values.buf[0]))) goto L0002;
            q = ctx->pos;
            chunk->capts.buf[0].range.start = p;
            chunk->capts.buf[0].range.end = q;
                    }
        ...
        ctx->pos++;
        {
            pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_define_assign_var_stat_0, 2, 2);
            thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
            thunk->data.leaf.values.buf[1] = &(chunk->values.buf[1]);
            thunk->data.leaf.capts.buf[0] = &(chunk->capts.buf[0]);
            thunk->data.leaf.capts.buf[1] = &(chunk->capts.buf[1]);
    ...
    L0002:;
        ctx->pos = p;
        pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
                        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_define_var_stat, &chunk->thunks, NULL)) goto L0003;
        goto L0001;
    L0003:;
        ctx->pos = p;
        pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_define_var_stat(lc_context_t *ctx) {
    ...
    L0001:;
        {
            pcc_value_t null;
            pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_define_var_stat_0, 1, 1);
            thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
            thunk->data.leaf.capt0.range.start = chunk->pos;
            thunk->data.leaf.capt0.range.end = ctx->pos;
            memset(&null, 0, sizeof(pcc_value_t)); /* in case */
    ...
    ctx->pos++;
    {
        pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_define_var_stat_1, 1, 1);
        thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
        thunk->data.leaf.capts.buf[0] = &(chunk->capts.buf[0]);
        thunk->data.leaf.capt0.range.start = chunk->pos;
        thunk->data.leaf.capt0.range.end = ctx->pos;
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_define_var(lc_context_t *ctx) {
    ...
    L0001:;
        {
            pcc_value_t null;
            pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_define_var_0, 1, 1);
            thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
            thunk->data.leaf.capt0.range.start = chunk->pos;
            thunk->data.leaf.capt0.range.end = ctx->pos;
            memset(&null, 0, sizeof(pcc_value_t)); /* in case */
    ...
    L0003:;
        {
            pcc_value_t null;
            pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_define_var_1, 1, 1);
            thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
            thunk->data.leaf.capt0.range.start = chunk->pos;
            thunk->data.leaf.capt0.range.end = ctx->pos;
            memset(&null, 0, sizeof(pcc_value_t)); /* in case */
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_type_expr(lc_context_t *ctx) {
    ...
    L0002:;
        ...
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule__, &chunk->thunks, NULL)) goto L0009;
        {
            ...
            ctx->pos++;
            if (!pcc_apply_rule(ctx, pcc_evaluate_rule__, &chunk->thunks, NULL)) goto L0009;
            if (!pcc_apply_rule(ctx, pcc_evaluate_rule_expression, &chunk->thunks, &(chunk->values.buf[1]))) goto L0010;
        L0010:;
            if (!pcc_apply_rule(ctx, pcc_evaluate_rule__, &chunk->thunks, NULL)) goto L0009;
            {
                if (
            ...
            L0011:;
                {
                    pcc_value_t null;
                    pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_type_expr_0, 4, 2);
                    thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
                    thunk->data.leaf.values.buf[1] = &(chunk->values.buf[1]);
                    thunk->data.leaf.capt0.range.start = chunk->pos;
                    thunk->data.leaf.capt0.range.end = ctx->pos;
    ...
    L0009:;
        ctx->pos = p;
        pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
                        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_type_attr, &chunk->thunks, &(chunk->values.buf[2]))) goto L0013;
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule__, &chunk->thunks, NULL)) goto L0013;
        {
            if (!pcc_apply_rule(ctx, pcc_evaluate_rule_type_expr, &chunk->thunks, &(chunk->values.buf[0]))) goto L0014;
            goto L0015;
        L0014:;
            {
                pcc_value_t null;
                pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_type_expr_1, 4, 2);
                thunk->data.leaf.values.buf[2] = &(chunk->values.buf[2]);
                thunk->data.leaf.capt0.range.start = chunk->pos;
                thunk->data.leaf.capt0.range.end = ctx->pos;
                memset(&null, 0, sizeof(pcc_value_t)); /* in case */
    ...
    L0013:;
        ...
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule__, &chunk->thunks, NULL)) goto L0016;
        {
            ...
            int i;
            for (i = 0;; i++) {
                if (!pcc_apply_rule(ctx, pcc_evaluate_rule_define_var_stat, &chunk->thunks, &(chunk->values.buf[3]))) goto L0017;
            }
        L0017:;
            if (i < 1) {
                ctx->pos = p;
        ...
        {
            pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_type_expr_2, 4, 2);
            thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
        ...
        L0018:;
            {
                pcc_value_t null;
                pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_type_expr_3, 4, 2);
                thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
                thunk->data.leaf.values.buf[3] = &(chunk->values.buf[3]);
                thunk->data.leaf.capt0.range.start = chunk->pos;
                thunk->data.leaf.capt0.range.end = ctx->pos;
    ...
    L0016:;
        ...
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule__, &chunk->thunks, NULL)) goto L0020;
        {
            ...
            int i;
            for (i = 0;; i++) {
                if (!pcc_apply_rule(ctx, pcc_evaluate_rule_define_var_stat, &chunk->thunks, NULL)) goto L0021;
            }
        L0021:;
            if (i < 1) {
                ctx->pos = p;
        ...
        L0022:;
            {
                pcc_value_t null;
                pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_type_expr_4, 4, 2);
                thunk->data.leaf.capt0.range.start = chunk->pos;
                thunk->data.leaf.capt0.range.end = ctx->pos;
                memset(&null, 0, sizeof(pcc_value_t)); /* in case */
                thunk->data.leaf.action(ctx, thunk, &null);
    ...
    L0020:;
        ...
        {
            if (!pcc_apply_rule(ctx, pcc_evaluate_rule_ident, &chunk->thunks, &(chunk->values.buf[0]))) goto L0025;
            goto L0026;
        L0025:;
            {
                pcc_value_t null;
                pcc_thunk_t *thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_type_expr_5, 4, 2);
                thunk->data.leaf.capt0.range.start = chunk->pos;
                thunk->data.leaf.capt0.range.end = ctx->pos;
                memset(&null, 0, sizeof(pcc_value_t)); /* in case */
                thunk->data.leaf.action(ctx, thunk, &null);
    ...
    L0024:;
        ctx->pos = p;
        pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
                        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_ident, &chunk->thunks, &(chunk->values.buf[0]))) goto L0027;
        ...
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule__, &chunk->thunks, NULL)) goto L0027;
        {
            int p = ctx->pos;
            int n = chunk->thunks.len;
                        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_type_expr, &chunk->thunks, NULL)) goto L0029;
            goto L0028;
        L0029:;
            ctx->pos = p;
            pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
                                    if (!pcc_apply_rule(ctx, pcc_evaluate_rule_expression, &chunk->thunks, NULL)) goto L0030;
            goto L0028;
        L0030:;
            ctx->pos = p;
            pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
        ...
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule__, &chunk->thunks, NULL)) goto L0027;
        {
            ...
            for (i = 0;; i++) {
                ...
                if (!pcc_apply_rule(ctx, pcc_evaluate_rule__, &chunk->thunks, NULL)) goto L0031;
                {
                    int p = ctx->pos;
                    int n = chunk->thunks.len;
                                        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_type_expr, &chunk->thunks, NULL)) goto L0033;
                    goto L0032;
                L0033:;
                    ctx->pos = p;
                    pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
    ...
    L0027:;
        ctx->pos = p;
        pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
                        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_ident, &chunk->thunks, &(chunk->values.buf[0]))) goto L0035;
        goto L0001;
    L0035:;
        ctx->pos = p;
        pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
